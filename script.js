...
let response_comment= fetch('http://13.237.248.97:7080/comment/all');
...
async function addComment(commentText) {
  await fetch('http://13.237.248.97:7080/todo/add', {
    method: 'POST',
...
async function removeFromDb(_id) {
  try {
    const response = await fetch(`http://13.237.248.97:7080/todo/remove/${_id}`);
    if (response.ok) {
...
async function listUpTodos(){
  await fetch('http://13.237.248.97:7080/todos')
  .then((response) => {
